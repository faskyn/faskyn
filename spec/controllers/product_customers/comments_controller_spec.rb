...
describe ProductCustomers::CommentsController do
  ...
  describe "when user is logged in" do
    ...
    describe "POST create" do
      ...
      let!(:commentable) { create(:product_customer, product: product) }

      context "with valid attributes" do
        subject(:create_action) { xhr :post, :create, product_customer_id: commentable, comment: attributes_for(:comment, commentable: commentable, user: @user) }
      ...
      context "with invalid attributes" do
        subject(:create_action) { xhr :post, :create, product_customer_id: commentable, comment: attributes_for(:comment, commentable: commentable, user: @user, body: "") }
