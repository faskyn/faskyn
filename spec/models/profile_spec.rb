...
RSpec.describe Profile, type: :model do
  ...
  describe "model validations" do
    ...
    it "has a valid factory" do
      expect(build_stubbed(:profile)).to be_valid
    end  

    it "is invalid without lastname" do
      expect(build_stubbed(:profile, last_name: nil)).not_to be_valid
    end

    it "is invalid without title" do
      expect(build_stubbed(:profile, job_title: nil)).not_to be_valid
    end

    it "is invalid without company" do
      expect(build_stubbed(:profile, company: nil)).not_to be_valid
    end

    it "is invalid without user_id" do
      expect(build_stubbed(:profile, user_id: nil)).not_to be_valid
    end
